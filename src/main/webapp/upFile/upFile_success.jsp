...
<div id="container" style="width:1000px; margin:auto; background: -webkit-linear-gradient(top left, #ffe3d9 0%, #53e3a6 100%);background: linear-gradient(to bottom right, #ffe3d9 0%, #53e3a6 100%);" >
    ...
    <!--右边显示栏-->
    <div id="content" style="margin:auto;height:450px;width:1000px;float:left;padding-top:10px;">
        <div>
            <span style="color:blueviolet;">上传成功</span></br>
            <span style="color:blueviolet;">文件路径:</span>${img}<br/>
            <span style="color:blueviolet;">文件名:</span>${imgFileName}<br/>
            <span style="color:blueviolet;">文件类型:</span>${imgContentType}<br/>
        </div>
    </div>
