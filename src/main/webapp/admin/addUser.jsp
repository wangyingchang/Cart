...
<div id="main" style="height: 800px; width:1000px; margin: auto; background: -webkit-linear-gradient(top left, #ffe3d9 0%, #53e3a6 100%);background: linear-gradient(to bottom right, #ffe3d9 0%, #53e3a6 100%);">
    ...
    <div id="header" style="text-align: center;">
        ...
        <a href="/html/index.jsp" style="color:black;text-decoration: none;" onclick="return confirmZX()"><button class="button button4">退出登录</button></a>
    </div><hr/>
    ...
    <div id="body" style="text-align: center;">
        ...
        <form action="/user/addUser" method="get">
            <input type="text" name="user.userName" placeholder="用户名" required oninvalid="setCustomValidity('请输入用户名！');" oninput="setCustomValidity('')" />
            <br/>
            <input type="text" name="user.userPwd" placeholder="用户密码" required oninvalid="setCustomValidity('请输入用户密码！');" oninput="setCustomValidity('')"  />
            <br/>
            <input type="email" name="user.userEamil" placeholder="邮箱" required oninvalid="setCustomValidity('请输入正确的邮箱！');" oninput="setCustomValidity('')" />
            <br/>
