...
<div id="main" style="height: 800px; width:1000px; margin: auto; background: -webkit-linear-gradient(top left, #ffe3d9 0%, #53e3a6 100%);background: linear-gradient(to bottom right, #ffe3d9 0%, #53e3a6 100%);">
    ...
    <div id="body" style="text-align: center;">
        ...
        <h1>修改商品信息</h1>
        <form action="/user/updateGoods" method="get" >
            <s:iterator value="#session.goodssByIdList">
                <input type="hidden" name="goods.gid" value="${gid}"/><br/>
                  <input type="text" name="goods.gname" value="${gname}" onmousemove="if(this.value=='${gname}'){this.value='商品名称'};" onmouseout="if(this.value=='商品名称'){this.value='${gname}'}"/><br/>
                  <input type="text" name="goods.gprice" value="${gprice}" onmousemove="if(this.value=='${gprice}'){this.value='商品价格'};" onmouseout="if(this.value=='商品价格'){this.value='${gprice}'}"/><br/>
                  <input type="text" name="goods.gdesc" value="${gdesc}" onmousemove="if(this.value=='${gdesc}'){this.value='商品描述'};" onmouseout="if(this.value=='商品描述'){this.value='${gdesc}'}"/><br/>
                  <select name="goods.gsort" >
                          <option value="${gsort}">${gsort}</option>
