...
<div id="main" style="height: 800px; width:1000px; margin: auto; background: -webkit-linear-gradient(top left, #ffe3d9 0%, #53e3a6 100%);background: linear-gradient(to bottom right, #ffe3d9 0%, #53e3a6 100%);">
    ...
    <div id="body" style="text-align: center;">
        ...
        <h1>添加购物车</h1>
        <!--表单-->
        <form action="/user/addCartitem" method="get">
            <input type="text" name="cartitem.uid" placeholder="用户ID" required oninvalid="setCustomValidity('请输入用户ID！');" oninput="setCustomValidity('')" />
            <br/>
            <input type="text" name="cartitem.gid" placeholder="商品ID"  required oninvalid="setCustomValidity('请输入商品ID！');" oninput="setCustomValidity('')" />
            <br/>
            <input type="text" name="cartitem.gname" placeholder="商品名称" required oninvalid="setCustomValidity('请输入商品名称！');" oninput="setCustomValidity('')" />
            <br/>
            <input type="text" name="cartitem.gdesc" placeholder="商品描述"  required oninvalid="setCustomValidity('请输入商品描述！');" oninput="setCustomValidity('')" />
            <br/>
